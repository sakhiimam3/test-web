"use client"
import { Box, Button, Container, ListItem, OrderedList, SimpleGrid, Stack, Switch,Text } from "@chakra-ui/react"
                ...
                <Box  display="flex" justifyContent="space-between" alignItems="center" >
                    <Box display="flex" justifyContent="center" alignItems="center">
                        <Box display="flex" bg="transparent" alignItems="center">
                            ...
                            <select style={{ background: 'transparent', color: '#6E7CA0' }} defaultValue="en">
                    ...
                    <Box display="flex" alignContent="center" justifyContent="center">
                        <OrderedList sx={{ listStyle: 'none', color: '#6E7CA0' }} display="flex" justifyContent="center" alignItems="center" gap="20px">
